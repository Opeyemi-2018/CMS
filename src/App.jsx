    ...
    <div className="lg:px-16 px-6">
      <div className="mt-20 mb-12 flex gap-2 flex-col md:items-center items-start">
        ...
        <p className="md:text-center md:w-[700px] w-full text-gray-700 md:text-[20px] text-[22px]">
          Explore definitions and explanations for terms relating to the world
          of CMSes and Sanity. Let this be your guide to the content management
          world.
        </p>
      </div>
      ...
      <nav
        className={`overflow-x-auto py-2 ${
          isFixed ? "fixed top-0 left-0 right-0 bg-white shadow-md z-10" : ""
        }`}
      >
      ...
      <div className="my-10 mb-20">
        <div className="mb-4 flex items-center justify-between gap-36">
          <div className="lg:flex hidden flex-col gap-1 text-nowrap">
            <h1 className="flex text-nowrap items-center gap-1 font-semibold text-gray-700">
              <span>
                <IoBookOutline />
              </span>
              All glossary terms
            ...
            {glossarys.map((glossary) => {
              ...
              return (
                <div key={id} className="mt-2">
                  <h1 className="lg:inline hidden text-nowrap text-gray-700">
                    {title}
                  </h1>
                </div>
              );
